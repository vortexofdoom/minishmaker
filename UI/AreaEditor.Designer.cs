namespace MinishMaker.UI
{
	partial class AreaEditor
	{
		...
		private void InitializeComponent()
		{
			...
			this.areaSongId.LostFocus += new System.EventHandler(AreaChanged);
			// 
			// HiddenLabel
			// 
			...
			this.keysShown.Location = new System.Drawing.Point(12, 457);
			...
			this.keysShown.CheckedChanged += new System.EventHandler(AreaChanged);
			// 
			// redName
			// 
			this.redName.AutoSize = true;
			this.redName.Enabled = false;
			this.redName.Location = new System.Drawing.Point(112, 457);
			...
			this.redName.CheckedChanged += new System.EventHandler(AreaChanged);
			// 
			// dungeonMap
			// 
			...
			this.dungeonMap.CheckedChanged += new System.EventHandler(AreaChanged);
			// 
			// canFlute
			// 
			this.canFlute.AutoSize = true;
			this.canFlute.Enabled = false;
			this.canFlute.Location = new System.Drawing.Point(240, 457);
			...
			this.canFlute.CheckedChanged += new System.EventHandler(AreaChanged);
			// 
			// moleCave
			// 
			...
			this.moleCave.CheckedChanged += new System.EventHandler(AreaChanged);
			// 
			// areaNameId
			// 
